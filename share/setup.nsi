...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\veles-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Veles Core (testnet, -bit).lnk" "$INSTDIR\veles-qt" "-testnet" "$INSTDIR\veles-qt" 1
    ...
    WriteRegStr HKCR "veles" "URL Protocol" ""
    WriteRegStr HKCR "veles" "" "URL:Veles"
    WriteRegStr HKCR "veles\DefaultIcon" "" $INSTDIR\veles-qt
    WriteRegStr HKCR "veles\shell\open\command" "" '"$INSTDIR\veles-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\veles-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Veles Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\Veles.lnk"
