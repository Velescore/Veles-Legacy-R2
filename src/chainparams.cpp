...
public:
    CMainParams()
    {
        ...
        nBlockZerocoinV2 = 18000000; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zvls to be stakable
