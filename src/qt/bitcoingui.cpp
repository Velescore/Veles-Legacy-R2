                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VELES Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVLS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VELES Core"), this);
    aboutAction->setStatusTip(tr("Show information about VELES Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VELES"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the VELES Core help message to get a list with possible VELES command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VELES Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VELES network", "", count));
}
...
{
    QString strTitle = tr("VELES Core"); // default title
