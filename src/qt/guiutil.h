...
/** Utility functions used by the VELES Qt UI.
 */
namespace GUIUtil
{
...
// Render VELES addresses in monospace font
...
// Parse "veles:" URI into recipient object, return true on successful parsing
