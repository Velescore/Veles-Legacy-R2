...
// Copyright (c) 2015-2018 The VELES developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VELES features */
        {"veles", "masternode", &masternode, true, true, false},
        {"veles", "listmasternodes", &listmasternodes, true, true, false},
        {"veles", "getmasternodecount", &getmasternodecount, true, true, false},
        {"veles", "masternodeconnect", &masternodeconnect, true, true, false},
        {"veles", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"veles", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"veles", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"veles", "masternodecurrent", &masternodecurrent, true, true, false},
        {"veles", "masternodedebug", &masternodedebug, true, true, false},
        {"veles", "startmasternode", &startmasternode, true, true, false},
        {"veles", "createmasternodekey", &createmasternodekey, true, true, false},
        {"veles", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"veles", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"veles", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"veles", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"veles", "getmasternodescores", &getmasternodescores, true, true, false},
        {"veles", "mnbudget", &mnbudget, true, true, false},
        {"veles", "preparebudget", &preparebudget, true, true, false},
        {"veles", "submitbudget", &submitbudget, true, true, false},
        {"veles", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"veles", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"veles", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"veles", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"veles", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"veles", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"veles", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"veles", "checkbudgets", &checkbudgets, true, true, false},
        {"veles", "mnsync", &mnsync, true, true, false},
        {"veles", "spork", &spork, true, true, false},
        {"veles", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzvlsseed", &getzvlsseed, false, false, true},
        {"zerocoin", "setzvlsseed", &setzvlsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzvls", &searchdzvls, false, false, true},
        {"zerocoin", "dzvlsstate", &dzvlsstate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25522/\n";
}
