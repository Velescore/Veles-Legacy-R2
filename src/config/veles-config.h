/* src/config/veles-config.h.  Generated from veles-config.h.in by configure.  */
/* src/config/veles-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.veles.network"
