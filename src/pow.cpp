...
unsigned int CalculateNextWorkRequiredCrypostle(const CBlockIndex* pindexLast, int64_t nFirstBlockTime)
{
    ...
    LogPrintf("params.nPowTargetTimespan = %d    nActualTimespan = %d\n", params.nPowTargetTimespan, nActualTimesp$
...
unsigned int GetNextWorkRequiredPIVX(const CBlockIndex* pindexLast, const CBlockHeader* pblock)
{
    /* current difficulty formula, veles - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
