...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT1200IFMN = 3,
    ONLY_NONDENOMINATED_NOT1200IFMN = 4, // ONLY_NONDENOMINATED and not 1200 VLS at the same time
    ONLY_1200 = 5,                        // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzVLSTracker> zpivTracker;
    ...
    {
        zwalletMain = zwallet;
        zpivTracker = std::unique_ptr<CzVLSTracker>(new CzVLSTracker(strWalletFile));
    }
